...
const projectsData: Project[] = [
  {id: 9, title: 'NutriGenie - AI Diet Planner', description: 'NutriGenie is a full-stack AI-powered diet planning web app. It generates personalized diet plans based on user goals, health metrics, and preferences. Built with React, Node.js, Express, MongoDB, and integrated with Gemini for dynamic meal planning. It supports user authentication, profile management, and stores multiple diet plans.',technologies: ["React","Node.js","Express.js", "MongoDB","Tailwind CSS","Gemini API","JWT","Google OAuth","Render Hosting","React-PDF"],imageUrl: '/images/nutrigenie.png',imageHint: 'nutrition dashboard planner',githubUrl: 'https://github.com/AnanditaSaxenaa/nutrigenie',liveUrl: 'https://nutrigenie-app.onrender.com/'},
